        ...
        <section className={style.background}>
            <div className={style.privacyContainer}>
                ...
                <div>
                    ...
                    <ol>
                        <li>Niniejsza polityka dotyczy Serwisu www, funkcjonującego pod adresem url: <b>KetoZocha.pl</b></li>
                        <li>Operatorem serwisu oraz Administratorem danych osobowych jest: KetoZocha.pl</li>

                        <li>Adres kontaktowy poczty elektronicznej operatora: ketozocha@gmail.com</li>
